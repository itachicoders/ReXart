...
# ReXart
**ReXart** — форк [AniDesk](https://github.com/theDesConnet/AniDesk).

Этот репозиторий создан на основе исходного проекта AniDesk и не позиционируется как полностью авторская разработка с нуля.  
Основная цель репозитория — развитие форка, внесение исправлений, улучшений и собственных изменений.
